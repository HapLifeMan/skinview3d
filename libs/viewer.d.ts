...
import { Color, type ColorRepresentation, PointLight, Group, PerspectiveCamera, Scene, Texture, WebGLRenderer, AmbientLight } from 'three';
...
export declare class SkinViewer {
    ...
    loadBackground<S extends TextureSource | RemoteImage>(source: S, mapping?: any): S extends TextureSource ? void : Promise<void>;
    private draw;
    /**
