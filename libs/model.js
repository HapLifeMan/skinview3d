import { BoxGeometry, BufferAttribute, DoubleSide, FrontSide, Group, Mesh, MeshBasicMaterial, Object3D, Texture, Vector2, Vector3, Euler, } from 'three';
...
export class BodyAttachment {
    constructor(parent, object, offset = new Vector3(), rotation = new Euler()) {
...
export class SkinObject extends Group {
    constructor() {
        super();
        // body parts
        Object.defineProperty(this, "torso", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
