...
import { Group, Mesh, Object3D, Texture, Vector3, Euler } from 'three';
/**
...
export declare class BodyAttachment {
    private parent;
    private object;
    private offset;
    private rotation;
    constructor(parent: Object3D, object: Object3D, offset?: Vector3, rotation?: Euler);
}
